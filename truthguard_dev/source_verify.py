...
def extraire_source_url(url):
    parsed_url = urlparse(url)
    source = parsed_url.netloc
    return source

def verifier_source_url(url, base_de_donnees):
    source_article = extraire_source_url(url)
    if source_article in base_de_donnees:
        source_info = base_de_donnees[source_article]
        if source_info['fiable']:
            print("La source de l'article est fiable.")
        else:
            print("La source de l'article n'est pas fiable.")
    else:
        print("La source de l'article n'est pas reconnue.")

url = "https://www.bbc.com/news/world-europe-66037913"
